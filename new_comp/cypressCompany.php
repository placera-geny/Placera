...
<div class="container">
 ...
 <img src="cypress.png" width="30%;" class="logo_company" style=" margin-left: 33.3%; margin-top: 2%; margin-bottom: 2%;">
...
<div class="container">
  ...
  <ul>
  <li style="font-size: 130%;">Some people accept the world as it is. Then there's the rest of us-the people who see room for improvement and tinker with what most take for granted.
  </li>
  <li style="font-size: 130%;" >We see a world of problems AND IT IS AWESOME. Problems get us thinking. Problems push boundaries. Problems make tomorrow more interesting.
  </li>
  <li style="font-size: 130%;" >We love problems because we're obsessed with creating solutions. So bring them on. It's what we live for. It's what we're here to do.
  </li>
  <li style="font-size: 130%;" >Cypress 3.0 is our plan to target markets growing faster than the broader semiconductor industry with embedded systems solutions: combinations of MCUs, wireless connectivity, analog, USB and memory products plus the software to enable them to work together flawlessly.
  </li>
  <li style="font-size: 130%;" >Nothing excites us more than human ingenuity. As engineers, our role is to give innovators and out-of-the-box thinkers the tools to create breakthrough products and disrupt markets-in record time.
  </li>
  </ul>
</div>
...
<div class="container">
   <h1 style="font-family: sans-serif; text-align: center; font-size: 300%; margin-bottom: 4%; color: rgb(0,0,0);">What we want</h1>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="card-block">
        ...
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">B.Tech & M.Tech</p>
       </div>
    </div>
  </div>
   ...
   <div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">60</p>
       </div>
    </div>
    </div>
      ...
      <div class="card" style="margin-bottom: 18%;">
      <div class="card-block">
        <h3 class="card-title" style="text-align: center; font-size: 200%; margin-top: 3%; color: #2E120C;">BTech & M.Tech CGPA</h3>
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">8</p>
       </div>
    </div>
    </div>
...
<div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">CSE, EEE , ECE, ICE, Embedded and VLSI</p>
       </div>
    </div>
  </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6">
     <div class="card" style="margin-bottom: 15%;">
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">9 to 11 L.p.a</p>
       </div>
    </div>
    </div>
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">Design Engineers, Test Engineers, Application Engineers, Operation Analysts and Product Engineers</p>
       </div>
    </div>
    </div>
