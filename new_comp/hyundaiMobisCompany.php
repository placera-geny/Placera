...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
  <title>Company-Hyundai Mobis</title>
...
<div class="container">
 ...
 <img src="hyundai_mobis.png" width="30%;" class="logo_company" style=" margin-left: 33.3%; margin-top: 2%; margin-bottom: 2%;">
...
<div class="container">
  ...
  <ul>
  <li style="font-size: 130%;">As an automotive parts company founded in 1977, Hyundai MOBIS produces and supplies products such as automotive modules, core automotive parts, and after-sales parts, and has been recently ranked sixth among global automotive parts suppliers. Aiming at creating value for the safety and happiness of customers, Hyundai MOBIS is increasing its influence in the automotive parts industry through superior quality and technology
  </li>
  <li style="font-size: 130%;" >Hyundai MOBIS is continuously working towards the future through challenges and innovations to rise up to be a leading automotive parts supplier in the world. It has grown to be the sixthranked global automotive parts supplier in only 10 years since it entered the automotive parts industry, and based on this potential, it is now aiming to become the company that takes the lead in changing global market and leads future automotive technology.
  </li>
  <li style="font-size: 130%;" >We promote a customer-driven corporate culture by providing the best quality and impeccable service with all values centered on our customers.
  </li>
  <li style="font-size: 130%;" >We refuse to be complacent, embrace every opportunity for greater challenge, and are confident in achieving our goals with unwavering passion and ingenious thinking.
  </li>
  <li style="font-size: 130%;" >We create synergy through a sense of “togetherness” that is fostered by mutual communication and cooperation within the company and with our business partners.
  </li>
  <li style="font-size: 130%;" >We believe the future of our organization lies in the hearts and capabilities of individual members, and will help them develop their potential by creating a corporate culture that respects talent
  </li>
  <li style="font-size: 130%;" >We respect the diversity of cultures and customs, aspire to be the world’s best at what we do, and strive to become a respected global corporate citizen.
...
<div class="container">
   <h1 style="font-family: sans-serif; text-align: center; font-size: 300%; margin-bottom: 4%; color: rgb(0,0,0);">What we want</h1>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6">
      <div class="card" style="margin-bottom: 18%;" >
   ...
   <div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">7</p>
       </div>
    </div>
    </div>
...
<div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">CSE, IT, Software, EEE, ECE, EIE and ITCE</p>
       </div>
    </div>
  </div>
  ...
  <div class="col-lg-6 col-md-6 col-sm-6">
   <div class="card" style="margin-bottom: 15%;">
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">Core</p>
       </div>
    </div>
  </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6">
     <div class="card" style="margin-bottom: 15%;">
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">CTC : 4 L.p.a</p>
       </div>
    </div>
    </div>
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">Hyderabad</p>
       </div>
    </div>
    </div>
...
<div class="container">
 ...
 <p style="text-align: center; margin-left: 15%; margin-right: 15%; font-size: 120%; margin-bottom: 5%; font-family: sans-serif; color: rgb(71, 67, 66  );">SAP is at the centre of today’s technology revolution. The market leader in enterprise application software, SAP helps organisations fight the damaging effects of complexity, generate new opportunities for innovation and growth, and stay ahead of the competition
</p>
<hr>
<p style="font-family: sans-serif; font-size: 250%; ">Recruitment Process</p>
<p style="font-size: 130%; margin-bottom: 3%;">The recruitment process of <strong>SAP Labs</strong> has 3 main rounds:</p>
