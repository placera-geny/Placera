...
<div class="container">
 ...
 <img src="2adpro.png" width="30%;" class="logo_company" style=" margin-left: 33.3%; margin-top: 2%; margin-bottom: 2%;">
...
<div class="container">
  ...
  <ul>
  <li style="font-size: 130%;"><b>Our vision</b> - To be the creative hub of the flat world. 
  </li>
  <li style="font-size: 130%;" ><b>Our mission</b> - The classic early 2006 start in a garage to write the business plan that not only leveraged the offshore economies of scale but also the key technology component will allow for easy adoption of the strategy to solve a business problem for media companies and brands.
  </li>
  <li style="font-size: 130%;" >Our solution was strong enough right out the door to attract some of the largest media houses and brands in the world to sign on. 
  </li>
  <li style="font-size: 130%;" > From there we continue to further refine our solutions, technology and our operations that spans across channels managed by a team of over 1,000 strategists, designers, developers, support teams.</li>
  </ul>
</div>
...
<div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">CSE, IT, Software, and ECE</p>
       </div>
    </div>
  </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6">
     <div class="card" style="margin-bottom: 15%;">
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">4.5 L.p.a</p>
       </div>
    </div>
    </div>
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">Junior Product Engineer</p>
       </div>
    </div>
    </div>
