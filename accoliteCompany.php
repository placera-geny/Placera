...
<div class="container">
 ...
 <img src="accolite.JPG" width="30%;" class="logo_company" style=" margin-left: 33.3%; margin-top: 2%; margin-bottom: 2%;">
...
<div class="container">
  ...
  <ul>
  <li style="font-size: 130%;">Accolite is a global IT Services company headquartered in Dallas, USA with offices in India. Recognized for providing cutting edge information technology services with a proven track record of being totally client focussed, Accolite promises efficient, affordable and on-time IT services. 
  </li>
  <li style="font-size: 130%;" >Starting with a humble beginning back in 2007 in Dallas with a single associate and a home office, today the company has grown to more than 750 associates distributed across multiple offices and geographic locations. A privately held organization, Accolite has been profitable from the first year of operation and serviced 100+ customers over the years.
  </li>
  <li style="font-size: 130%;" >'Accolite' is derived from the Greek Word 'Akolouthos' defined as a dedicated person who contributes to the fulfillment of a need. True to its meaning, Accolite has always been devoted to the IT needs of its clients and will continue to do so.
  </li>
  </ul>
</div>
...
<div class="container">
   ...
   <div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">ANY</p>
       </div>
    </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6">
     <div class="card" style="margin-bottom: 15%;">
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">10.1 L.p.a</p>
       </div>
    </div>
    </div>
