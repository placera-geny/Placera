...
<html>
<head>
	<title>Company-MORGAN STANLEY</title>
	 <meta charset="utf-8">
...
<div class="container">
 ...
 <img src="morgan-stanley.png" width="38%;" style=" margin-left: 33.3%; margin-top: 2%; margin-bottom: 1%;">
...
<div class="container">
  ...
  <ul>
  <li style="font-size: 130%;">Morgan Stanley is a leading global financial services firm providing investment banking, securities, wealth management and investment management services. It is headquartered at 1585 Broadway in the Morgan Stanley Building, Midtown Manhattan, New York City.</li>
  <li style="font-size: 130%;" >With offices in more than 42 countries and more than 55,000 employees, the firm's clients include corporations, governments, institutions and individuals</li>
  <li style="font-size: 130%;" >Morgan Stanley, formed by J.P. Morgan & Co. partners Henry Sturgis Morgan (grandson of J.P. Morgan), Harold Stanley and others, came into existence on September 16, 1935, in response to the Glass-Steagall Act that required the splitting of commercial and investment banking businesses.</li>
  <li style="font-size: 130%;" > In its first year the company operated with a 24% market share (US$1.1 billion) in public offerings and private placements. The main areas of business for the firm today are Institutional Securities, Wealth Management and Investment Management.</li>
  </ul>
</div>
...
<div class="container">
   ...
   <div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">7.5</p>
       </div>
    </div>
    </div>
...
<div class="col-lg-4 col-md-6 col-sm-6">
      <div class="card" style="margin-bottom: 18%;"style="margin-bottom: 18%;">
      <div class="card-block">
    ...
    <div class="col-lg-6 col-md-4 col-sm-4">
     <div class="card" style="margin-bottom: 18%;">
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">44,000/PM</p>
       </div>
    </div>
    </div>
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">Internship</p>
       </div>
    </div>
    </div>
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">MUMBAI/BANGALORE</p>
       </div>
    </div>
    </div>
...
<div class="container">
 ...
 <p style="text-align: center; margin-left: 15%; margin-right: 15%; font-size: 120%; margin-bottom: 5%; font-family: sans-serif; color: rgb(71, 67, 66  );">Our DNA, our culture and our history are rooted in serving our clients. Since our founding in 1935, Morgan Stanley has consistently delivered first-class business in a first-class way. Underpinning all that we do are four core values.
</p>
<hr>
<p style="font-family: sans-serif; font-size: 250%; ">Recruitment Process</p>
<p style="font-size: 130%; margin-bottom: 3%;">The recruitment process of <strong>Wells Fargo</strong> has 3 main rounds:</p>
