...
<html>
<head>
	<title>Company-INSIGHT SYSTEMS</title>
	 <meta charset="utf-8">
...
<div class="container">
 ...
 <img src="insight systems.jpeg" width="30%;" style=" margin-left: 34%; margin-top: 2%; margin-bottom: 1%;">
...
<div class="container">
  ...
  <ul>
  <li style="font-size: 130%;">Insight Enterprises Inc. is an Arizona-based publicly traded global technology company that focuses on business-to-business and information technology (IT) capabilities for enterprises.[</li>
  <li style="font-size: 130%;" >The company is listed on the Fortune 500 and has offices in 22 countries with operations in 200 countries and territories.</li>
  <li style="font-size: 130%;" >In 2013, Insight received the Transformational Licensing Solution Partner of the Year award from Microsoft. Company founders Eric and Tim Crown were awarded the OneNeck IT Services People's Choice Lifetime Achievement Award from Avnet Inc. at the November 2013 Arizona Governor's Celebration of Innovation Awards.</li>
  <li style="font-size: 130%;" >On November 7, 2016 Insight Enterprises announced that they were acquiring the Eden Prairie, Minnesota-based data storage company, Datalink for $11.25 per share in cash, but that the company would remain mostly the same.The $258 million deal closed in the first quarter of 2017 and allowed Insight Enterprises to enhance its data center services.</li>
  </ul>
</div>
...
<div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">CSE, IT, Software, EEE, ECE and Mechanical</p>
       </div>
    </div>
  </div>
    ...
    <div class="col-lg-6 col-md-4 col-sm-4">
     <div class="card" style="margin-bottom: 18%;" >
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">9 LPA</p>
       </div>
    </div>
    </div>
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">Data Engineer</p>
       </div>
    </div>
    </div>
...
<div class="container">
 ...
 <p style="text-align: center; margin-left: 15%; margin-right: 15%; font-size: 120%; margin-bottom: 5%; font-family: sans-serif; color: rgb(71, 67, 66  );">We build meaningful connections to help businesses run smarter.
</p>
<hr>
