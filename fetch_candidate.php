...
<p style="color: #F4F6F6; font-family: Quicksand, sans-serif; font-size: 150%; background-color: #0B5345; padding: 2%; border-radius: 15px 15px 15px 15px; text-align: center; width: 90%; "><i class="fas fa-clipboard-list" style="font-size: 140%; "></i> &ensp;Company Applications </p>
</div>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
       ...
       '<img class="rounded-circle" alt="My_photo" width="150px" height="150px" src=uploads/'.$row["comp_logo"].'>'.'<br>'.'<br>'.
       '<a style="color:#0B5345;" title="LinkedIn" href='.$row["comp_skill1"]. '>'.'<i class="fab fa-linkedin" style="font-size: 180%;"></i>'.'</a>'.'&emsp;'.
       '<a style="color:#0B5345;" title="Github" href='.$row["comp_skill2"]. '>'.'<i class="fab fa-github-square" style="font-size: 180%;"></i>'.'</a>'.'&emsp;'.
       '<a style="color:#0B5345;" title="Facebook" href='.$row["comp_skill3"]. '>'.'<i class="fab fa-facebook" style="font-size: 180%;"></i>'.'</a>'.'&emsp;'.
       '<a style="color:#0B5345;" title="Twitter" href='.$row["comp_skill4"]. '>'.'<i class="fab fa-twitter-square" style="font-size: 180%;"></i>'.'</a>'.
        '</div>'.
