...
<div class="container">
 ...
 <img src="NSE_Logo.jpg" width="30%;" style=" margin-left: 33.3%; margin-top: 2%; margin-bottom: 1%;">
...
<div class="container">
  ...
  <ul>
  <li style="font-size: 130%;">The National Stock Exchange of India Limited (NSE) is the leading stock exchange of India, located in Mumbai . The NSE was established in 1992 as the first demutualized electronic exchange in the country. </li>
  <li style="font-size: 130%;" >NSE was the first exchange in the country to provide a modern, fully automated screen-based electronic trading system which offered easy trading facility to the investors spread across the length and breadth of the country. Vikram Limaye is Managing Director & Chief Executive Officer (MD & CEO) of NSE.</li>
  <li style="font-size: 130%;" >National Stock Exchange has a total market capitalization of more than US$1.41 trillion, making it the world's 12th-largest stock exchange as of March 2016.</li>
  <li style="font-size: 130%;" > NSE was set up by a group of leading Indian financial institutions at the behest of the government of India to bring transparency to the Indian capital market. Based on the recommendations laid out by the government committee, NSE has been established with a diversified shareholding comprising domestic and global investors. </li>
  </ul>
</div>
...
<div class="container">
   ...
   <div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">85</p>
       </div>
    </div>
    </div>
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">8.5</p>
       </div>
    </div>
    </div>
...
<div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">CSE, IT, Software, EEE, ECE and MCA/p>
       </div>
    </div>
  </div>
    ...
    <div class="col-lg-6 col-md-4 col-sm-4">
     <div class="card" style="margin-bottom: 18%;">
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">CTC 5.6 LPA</p>
       </div>
    </div>
    </div>
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">Engineer Trainee</p>
       </div>
    </div>
    </div>
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">MUMBAI</p>
       </div>
    </div>
    </div>
...
<div class="container">
 ...
 <p style="text-align: center; margin-left: 15%; margin-right: 15%; font-size: 120%; margin-bottom: 5%; font-family: sans-serif; color: rgb(71, 67, 66  );">The logo of the NSE symbolises a single nationwide securities trading facility ensuring uniform access to investors, trading members and issuers all over the country. The initials of the Exchange viz., N, S and E have been etched on the logo and are distinctly visible. The logo symbolises simplicity, technology and connectivity, unleashing of creative energy to constantly innovate for the development and growth of the securities industry.
</p>
<hr>
<p style="font-family: sans-serif; font-size: 250%; ">Recruitment Process</p>
<p style="font-size: 130%; margin-bottom: 3%;">The recruitment process of <strong>Amazon</strong> has 3 main rounds:</p>
