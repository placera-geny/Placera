...
<div class="container">
 ...
 <img src="coviam.png" width="30%;" style=" margin-left: 33.3%; margin-top: 2%; margin-bottom: 1%;">
...
<div class="container">
  ...
  <ul>
  <li style="font-size: 130%;">Coviam is an upstart digital platforms and products company with a core focus on disrupting traditional markets and business models with the strength of our innovation driven digital value. </li>
  <li style="font-size: 130%;" > We harness the power of our open innovation culture, our unique talent selection approach, the skills and expertise of our people across various industries, domains and technologies and a unique blend of analytics driven strategies for creating future digital platforms.</li>
  <li style="font-size: 130%;" >The company was founded in 2015 and holds the strength of 201-500 employees.</li>
  <li style="font-size: 130%;" > Headquarters are located in Bangalore,Karnataka.</li>
...
<div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">CSE, IT, BigData, Cloud Computing and Software</p>
       </div>
    </div>
  </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6">
     <div class="card" style="margin-bottom: 15%;">
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">Intern Stipend : 22k Btech/25k Mtech  CTC : 5.5 l.p.a/6.0 l.p.a</p>
       </div>
    </div>
    </div>
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">Intern</p>
       </div>
    </div>
    </div>
...
<div class="container">
 ...
 <p style="text-align: center; margin-left: 15%; margin-right: 15%; font-size: 120%; margin-bottom: 5%; font-family: sans-serif; color: rgb(71, 67, 66  );">Coviam differentiates itself on multiple factors to be your trusted partner. We protect your intellectual property aligning contractual agreements and teams.
