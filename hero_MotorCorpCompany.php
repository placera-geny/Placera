...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
  <title>Company-Hero MotoCorp</title>
...
<div class="container">
 ...
 <img src="hero_motocorp.png" width="30%;" class="logo_company" style=" margin-left: 33.3%; margin-top: 2%; margin-bottom: 2%;">
...
<div class="container">
  ...
  <ul>
  <li style="font-size: 130%;">Hero MotoCorp Limited is the world's largest manufacturer of two-wheelers. The company has four manufacturing facilities namely Dharuhera and Gurgaon in Haryana, Haridwar in Uttarakhand and Neemrana in Rajasthan. The company is based in New Delhi, India. 
  </li>
  <li style="font-size: 130%;" >The company offers a range of bikes starting from CD Dawn, CD Deluxe, Splendor Plus, Splendor NXG, Passion and Passion Pro. The 125 cubic centimeter segment offers Glamour, Super Splendor and Glamour F1. It also has an offering called Achiever in 135 cubic centimeter segment. In the 150 cubic centimeter and above the company offers brands like Hunk, CBZ X-treme, Karizma and the Karizma ZMR. It also offers a 100 cubic centimeter scooter, Pleasure.
  </li>
  <li style="font-size: 130%;" >Hero MotoCorp Limited was incorporated in the year 1984 with the name Hero Honda Motors Ltd. The company was established as a joint venture company between Honda Motor Company of Japan and Hero Group. In the year 1983, they signed a joint collaboration agreement and formed the company. The joint venture between India's Hero Group and Honda Motor Company, Japan has not only created the world's single largest two wheeler company but also one of the most successful joint ventures worldwide.
  </li>
  <li style="font-size: 130%;" >Hero MotoCorp surpassed the landmark seven million units in cumulative sales in a calendar year in 2017. The company sold a record 7,207,363 units of two-wheelers in the calendar year in 2017.
  </li>
  </ul>
</div>
...
<div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 200%; margin-bottom: 5%; color: #EE810D; font-style: italic;">Mechanical</p>
       </div>
    </div>
  </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6">
     <div class="card" style="margin-bottom: 15%;">
      ...
      <div class="card-block">
        ...
        <hr width="70%" style="margin-top: 0; margin-bottom: 0;">
        <p class="card-text" style="text-align: center; font-size: 180%; margin-bottom: 5%; color: #EE810D; font-style: italic;">GET</p>
       </div>
    </div>
    </div>
